...
library Math {
   ...
   // uint256 public constant PERCENTAGE_SCALE = 1e6; // or whatever scale you use

    /**
     * @dev Calculate percentage with precision
     */
    // function calculateBackingRatio(uint256 minRequiredReserve, uint256 currentSupply) internal pure returns (uint256) {
    //     if (currentSupply == 0) return 0;
    //     return (minRequiredReserve * PERCENTAGE_SCALE) / currentSupply;
    // }
